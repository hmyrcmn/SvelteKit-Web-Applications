...
<script lang="ts">
	...
	let activeTab = 'Functional and Software Features';

	const tabContent = {
		'Functional and Software Features': {
			...
			image: './img/fonk.png',
			features: [
				'Real-time vehicle diagnostics with the HVD-AI software platform.',
				'Artificial Intelligence: Testing and analysis, Assistant (pre-repair prediction), Co-pilot (guidance during repair).',
				'Analyzes historical fault records and provides maintenance recommendations.',
				'Automatic data reporting with PDF/Excel export.',
				'Scenario Development: Test scenarios and unlimited user-defined scenarios.',
				'Automatic and centralized software updates.',
				'Intuitive touchscreen interface with multi-language support.'
			]
		},
		'Testing and Analysis Capacity': {
			icon: 'M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z',
			image: './img/co.png',
			features: [
				'Engine Control Unit (ECU) reading and code clearing.',
				'Electronic system testing including ABS, EBS, and transmission systems.',
				'Detection of electromechanical system and sensor failures.',
				'Detailed data flow analysis over CAN bus.',
				'Automatic fault code identification with solution suggestions.',
				'AI-powered algorithms for predictive analysis.',
				'System alerts and risk analysis module.'
			]
		},
		'Electronic Features and Connectivity': {
			...
			image: './img/cld.png',
			features: [
				'Processor: 1x dual core (550Mhz), 5x single core (240Mhz) ARM.',
				'Detection: 40 sensor inputs (5V/24VDC).',
				'Control: 6x solenoid (10A), 6x proportional solenoid (4-20mA, 0-10V).',
				'Connectivity: Automotive Ethernet, 6x CanBus, Dual FDCAN, LinBUS.',
				'Wireless: Wi-Fi 802.11 b/g/n, Bluetooth 5.1.',
				'Power Supply: 0-30V/5A software-controlled power output.',
				'Cloud-based data logging and vehicle history management.'
			]
		},
		'Mechanical and Hardware Features': {
			...
			image: './img/assis.png',
			features: [
				'Dimensions: 120x75x55 cm, Weight: 155 Kg (portable in service vehicle).',
				'Air: Max pressure 15.5 bar, 3 x 8 L air tanks.',
				'Safety: Emergency stop button and operational status light.',
				'Interface: 1 microphone, 2 speakers, high-resolution touchscreen display.',
				'Body: Industrial-grade durable, modular, and portable design.',
				'Patented technology (TR2023015406).'
			]
		}
	};
</script>
...
<section class="specs-section">
	<div class="container">
		<div class="section-header">
			...
			<h2 class="title">Detailed Technical Specifications</h2>
		</div>
