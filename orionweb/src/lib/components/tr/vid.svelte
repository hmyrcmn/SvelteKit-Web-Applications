<script>
  ...
  const videos = [
    {
      id: 'ebs-testleri',
      title: 'EBS Uygulama Örneği',
      description:
        'Bu videoda, EBS ürünümüzün temel özelliklerini ve pratik bir uygulama senaryosunu görebilirsiniz.',
    ...
    {
      id: 'apm-testleri',
      title: 'APM Uygulama Örneği',
      description:
        'APM sistemimizin performans izleme yeteneklerini ve olası sorunları nasıl tespit ettiğini bu örnekte inceleyin.',
      videoSrc: '/img/orion4.mp4',
      thumbnail: '/img/fonk.jpg',
      category: 'APM'
    },
    {
      id: 'eks-testleri',
      title: 'EKS Uygulama Örneği',
      description:
        'EKS çözümümüzün nasıl çalıştığını gösteren bu detaylı teknik videoyu izleyerek ürünümüz hakkında daha fazla bilgi edinin.',
      videoSrc: '/img/orion4.mp4',
      thumbnail: '/img/fonk.jpg',
      category: 'EKS'
    }
  ...
  onMount(() => {
    // Bu observer artık sadece başlık ve açıklama için çalışacak.
...
<section class="video-section elite-product-page">
  <div class="main-content">
    ...
    <p class="video-section-description vid-animate-on-scroll">
      Ürünümüzün temel özelliklerini ve çalışma prensiplerini detaylı teknik videolarımızla keşfedin.
    </p>
    ...
    <div class="video-container">
      ...
      <div class="video-sidebar">
        {#each videos as video, i}
          <!-- *** DÜZELTME: 'vid-animate-on-scroll' SINIFI BURADAN KALDIRILDI *** -->
          <button
